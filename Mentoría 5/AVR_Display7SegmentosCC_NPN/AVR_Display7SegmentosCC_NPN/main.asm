...
;DETALLES DEL PROYECTO
	; Display de 7 segmentos Cátodo Común : Se activan los segmentos con "1" 
	; Transistores NPN: Se activan los dígitos con "1"
;-------------------------
...
LOOP:
  ...
  NEGATIVO:
  ;ESTAMOS REPRESENTANDO EL SÍMBOLO MENOS (-) CON UN GUIÓN 
  LDI SALIDA, 0x01 ;SÍMBOLO MENOS: 0x01 EN CÁTODO COMÚN (SE ACTIVA CON 1) 
  ...
  AND MOSTRAR, SALIDA
  OUT PORTD, MOSTRAR
  CBI PORTB, 5 ;Desactivar MILLAR con "0" (NPN)
  SBI PORTB, 4 ;Activar CENTENA con "1" (NPN)
  CBI PORTB, 1 ;Desactivar DECENA con "0" (NPN)
  CBI PORTB, 0 ;Desactivar UNIDAD con "0" (NPN)
 
  CALL TIM_5
  RJMP NORMAL

  POSITIVO:
  ;0b01111110 ;NUMERO ZERO en cátodo comun
  ;ESTAMOS REPRESENTADO EL SÍMBOLO(+) CON UN CERO EN LAS CENTENAS
	CBI PORTD, 7;DP ->0
	SBI PORTD, 6;A
	SBI PORTD, 5;B
	SBI PORTD, 4;C
  ...
  SBI PORTB, 5 ;Activar MILLAR con "1" (NPN)
  SBI PORTB, 4 ;Activar CENTENA con "1" (NPN)
  CBI PORTB, 1 ;Desactivar DECENA con "0" (NPN)
  CBI PORTB, 0 ;Desactivar UNIDAD con "0" (NPN)
  ...
  RCALL DEC2DISPLAY
  CBI PORTB, 5  ;Desactivar MILLAR con "0" (NPN)
  CBI PORTB, 4  ;Desactivar CENTENA con "0" (NPN)
  SBI PORTB, 1	;Activar DECENA con "1" (NPN)
  CBI PORTB, 0  ;Desactivar UNIDAD con "0" (NPN)
  ...
  CBI PORTB, 4  ;Desactivar CENTENA con "0" (NPN)
  CBI PORTB, 1	;Desactivar DECENA con "0" (NPN)
  SBI PORTB, 0  ;Activar UNIDAD con "1" (NPN)
